...
5. **Circuit integrity** — walk every `ElectricalSystem`:
   ...
   `C:\Users\reed.pinterich\.Codex\routines\heb-qaqc\checks\electrical_check.py`.)
...
11. **In-document category-pair clash check** — bounding-box prefilter
    ...
    (Reference implementation: `C:\Users\reed.pinterich\.Codex\routines\heb-qaqc\checks\clash_check.py` —
